<script lang="ts">
    ...
    import WorkspaceInset from "$lib/components/app/theme-v2/WorkspaceInset.svelte";
...
<div class="flex h-full min-h-0 flex-col p-1.5 sm:p-2 md:p-2">
    <WorkspaceInset class="min-h-0 flex-1">
        ...
        >
            ...
            <div
                class="flex min-h-0 min-w-0 flex-col border-t border-border/70 md:border-t-0"
            >
