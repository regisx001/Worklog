...
<header
    bind:this={toolbarEl}
    class="relative z-[60] flex h-[var(--app-toolbar-height)] min-h-[var(--app-toolbar-height)] w-full items-center border-b border-border/80 bg-gradient-to-b from-surface-card to-card px-2 shadow-xs backdrop-blur-[1px]"
>
