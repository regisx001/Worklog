...
<aside
    ...
    class="text-sidebar-foreground flex h-auto max-h-[46vh] w-full flex-col border-b border-sidebar-border/80 bg-gradient-to-b from-surface-sidebar to-surface-panel md:h-full md:max-h-none md:w-60 md:border-r md:border-b-0 lg:w-72"
>
    <header
